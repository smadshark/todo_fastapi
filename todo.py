...
# async def get_query_todo(todo_id: int = Path(..., title="The ID of the todo to retrieve.")) -> dict:
#     for todo in todo_list:
#         if todo.id == todo_id:
#             return {
#                 "todo": todo
...
#
#     return {
#         "message": "Todo with supplied ID doesn't exist.2222"
#     }
...
async def update_todo(todo_data: TodoItem, todo_id: int = Path(..., title="The ID of the todo to be updated.")) -> dict:
    ...
    raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail={"code": "E443", "message": "Todo with supplied ID doesn't exists."})


@todo_router.delete("/todo/{todo_id}")
async def delete_todo(todo_id: int = Path(..., title="The ID of the todo to be deleted.")) -> dict:
